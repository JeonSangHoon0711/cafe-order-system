...
public class addOption extends JFrame{
	...
	public addOption(int selectedMenu) {
		...
		lab = new label("사이즈", 30, 350, 50, 20); c.add(lab);
		...
		lab = new label("휘핑 크림 추가", 30, 450, 100, 20); c.add(lab);
		lab = new label("600원", 200, 450, 100, 20); c.add(lab);
		...
		lab = new label("시럽 추가", 30, 530, 100, 20); c.add(lab);
		lab = new label("300원", 200, 530, 100, 20); c.add(lab);
		...
		lab = new label("샷 추가", 30, 610, 100, 20); c.add(lab);
		lab = new label("500원", 200, 610, 100, 20); c.add(lab);
		...
		cancel = new button("취소", 70, 680, 150, 50); c.add(cancel);
		finish = new button("선택완료", 280, 680, 150, 50); c.add(finish);
